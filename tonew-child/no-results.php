...
<section class="no-results not-found">
	<div class="inside-article">
		...
		<header class="entry-header">
			<h1 class="entry-title"><?php _e( 'Нічого не знайдено', 'generatepress' ); ?></h1>
		</header><!-- .entry-header -->
		...
		<div class="entry-content">
				...
				<?php elseif ( is_search() ) : ?>
					...
					<p><?php _e( 'Вибачте, але нічого не співпало з вашими пошуковими термінами. Будь ласка, спробуйте знову, використовуючи різні ключові слова.', 'generatepress' ); ?></p>
					<?php get_search_form(); ?>
