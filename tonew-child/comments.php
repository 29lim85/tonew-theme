...
<div id="comments">
	...
	<?php if ( have_comments() ) : ?>
			...
			<?php					
				...
				if ( 1 === $comments_number ) {
					printf(
						...
						esc_html_x( '1 коментарі &ldquo;%s&rdquo;', 'comments title', 'generatepress' ),
		...
		<nav id="comment-nav-above" class="comment-navigation" role="navigation">
			<h1 class="screen-reader-text"><?php _e( 'навігація', 'generatepress' ); ?></h1>
			<div class="nav-previous"><?php previous_comments_link( __( '&larr; старі коменти', 'generatepress' ) ); ?></div>
			<div class="nav-next"><?php next_comments_link( __( 'нові коменти &rarr;', 'generatepress' ) ); ?></div>
	...
	$defaults = array(
		...
		'id_form'              => 'commentform',
		'id_submit'            => 'submit',
		'title_reply'          => apply_filters( 'generate_leave_comment', __( 'залишити відгук','generatepress' ) ),
		'title_reply_to'       => apply_filters( 'generate_leave_reply', __( 'відповісти  %s','generatepress' ) ),
		'cancel_reply_link'    => apply_filters( 'generate_cancel_reply', __( 'Cancel ','generatepress' ) ),
		'label_submit'         => apply_filters( 'generate_post_comment', __( 'Опублікувати!','generatepress' ) ),
	);
